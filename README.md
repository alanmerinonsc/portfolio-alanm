...
- `/SQL_Basics/` – SQL queries, schema designs, and exercises  
...
- **Model Evaluation**: Includes metrics, confusion matrices, and visualizations.
- **Use Cases**: Customer churn prediction, sales forecasting, and anomaly detection.

### 2. Data_Generation
- **Synthetic Dataset Builders**: Python scripts to simulate realistic datasets for training and testing.
- **Tech Stack**: NumPy, Faker, pandas.
- **Applications**: BPO logistics, WFM simulations, and API mock data.

### 3. SQL_Basics
- **Query Practice**: SELECT, JOIN, GROUP BY, subqueries, and window functions.
- **Schema Design**: Sample ERDs and normalization examples.
- **Tools**: PostgreSQL, MySQL, and SQLite.
