...
Data has been generated using the "Fake Data Generator" program, which can be found under Python Utilities in this repo.
...
To simplify PostgreSQL setup, you can use Docker, which allows you to run the database in an isolated container without installing PostgreSQL locally.
...
This command will:
- `Launch a PostgreSQL 15 container named pg_portfolio`
- `Expose port 5432 to your local machine`
- `Create a database named ecommerce with user postgres and password postgres`
- `Initialize the database with SQL scripts from src/`

2. Connect to the Database
You can connect using any SQL client (e.g., psql, DBeaver, or pgAdmin) with:
...
### Notes
- `This setup allows you to run the database immediately without manual PostgreSQL installation.`
- `All initial schema and CSV imports will run automatically from the src/ folder.`
- `You can use this environment to test SQL queries, indexing, and performance analysis as described in the main project.`
